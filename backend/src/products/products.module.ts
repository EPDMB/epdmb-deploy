...
@Module({
  ...
  providers: [ProductsRepository, ProductsService, FairsService, FairsRepository, ProductRequestService, NotificationService, SellerRepository, UsersService, UserRepository],
})
